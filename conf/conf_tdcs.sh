...
#echo "4 done"
#board no. 005
trbcmd s 0x0000243900752941 0x01 0x0806  # OK
trbcmd s 0x0000606100752941 0x01 0x0807  # OK
...
#board no. 008
trbcmd s 0x000090d700752941 0x01 0x0812 # weak readout from channel 3/27/23 (but when you touch flex - increases)
trbcmd s 0x0000766e00752941 0x01 0x0813 # OK
...
#
trbcmd s 0x000009d700762941 0x01 0xc038
