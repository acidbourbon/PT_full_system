...
for TDC in 0x0350 0x0351 0x0352 0x0353 0x1500 0x1501 0x1502 0x1503 0x1800 0x1801 0x1802 0x1803 0x1807 0xfe91 ; do
# also for 0xfe91 ??
	...
	trbcmd w $TDC 0xc801 0x81400258
	...
	trbcmd w $TDC 0xc804 10
        ...
        # and also 50th channel
        trbcmd setbit $TDC 0xdf05 0x20000
...
#moved MDC 2.5cm to wall side
trbcmd loadbit 0x1807 0xd580 0x300 0x000
trbcmd loadbit 0x1812 0xd580 0x300 0x300
trbcmd loadbit 0x1820 0xd580 0x300 0x100
trbcmd loadbit 0x1821 0xd580 0x300 0x100
trbcmd loadbit 0x1808 0xd580 0x300 0x300
trbcmd loadbit 0x1817 0xd580 0x300 0x100
