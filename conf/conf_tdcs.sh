...
#board no. 005
trbcmd s 0x0000606100752941  0x01 0x1806  # OK
trbcmd s 0x0000243900752941  0x01 0x1807  # OK
...
#board no. 007
trbcmd s 0x00008fe100752941  0x01 0x1810 # OK
trbcmd s 0x0000905200752941  0x01 0x1811 # weak readout from channel 3/12/26/32 (but when you touch flex - increases)
