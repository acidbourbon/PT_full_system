...
trbcmd w 0xc035 0xa00d 0x00000001  # cts_eventbuilder: 
                            ...
                            # use_cal_eb=false
trbcmd w 0xc035 0xa101 0xffff4000  # trg_channel_mask: edge=1111 1111 1111 1111, mask=0100 0000 0000 0000
trbcmd w 0xc035 0xa124 0x00000014  # trg_input_config0: delay=20, invert=false, override=off, spike_rej=0
trbcmd w 0xc035 0xa125 0x00000014  # trg_input_config1: delay=20, invert=false, override=off, spike_rej=0
...
trbcmd w 0xc035 0xa12b 0x0000002d  # trg_input_config7: delay=45, invert=false, override=off, spike_rej=0
...
trbcmd w 0xc035 0xa148 0x00000029  # trg_input_mux7: input=itc[3]
