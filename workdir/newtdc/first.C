...
//    hadaq::TdcProcessor::SetDefaults(1000);
   ...
   hadaq::TrbProcessor::SetTDCRange(TDCRANGE_START, TDCRANGE_START);   //!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  //  hadaq::TrbProcessor::SetHUBRange(0x0350, 0x8400);
   ...
   trb->AddHadaqHUBId(0x8005);

   
   // create custom processor
   hadaq::MdcProcessor *mdc1 = new hadaq::MdcProcessor(trb, 0x1807);
    hadaq::MdcProcessor *mdc2 = new hadaq::MdcProcessor(trb, 0x1812);  
