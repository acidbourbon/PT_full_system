...
def start_hld_file(**kwargs):
    import os
    filename = kwargs.get("filename","")
    os.system("curl http://localhost:8091/EventBuilder/HadaqCombiner/StartHldFile/execute?filename={:s}.hld".format(filename))
def stop_hld_file(**kwargs):
     import os
